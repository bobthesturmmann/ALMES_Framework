...
string modulesRootPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Server", "MODULES");

if (!Directory.Exists(modulesRootPath))
{
    modulesRootPath = Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "Server", "MODULES");
}
